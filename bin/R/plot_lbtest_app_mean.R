...
pdf_name <- "~/work-ecl-vinicius/packdrop-data-analysis/icpp2018/results/apptime_lbtest_sdumont.pdf"
...
#resumed_data <- resumed_data[resumed_data$wildmetric=="Mesh2D",]
resumed_data <- resumed_data[resumed_data$app=="lb_test",]
